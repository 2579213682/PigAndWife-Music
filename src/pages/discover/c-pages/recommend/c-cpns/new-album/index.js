...
export default memo(function PigAndWifeNewAlbum(props) {
  // redux
  ...
  return (
    <AlbumWrapper>
      <PigAndWifeThemeHeaderRCM title="新碟上架" moreLink="/discover/album" />
              ...
              return (
                <div key={item} className="page">
                  ...
                  {state.newAlbum
                    ...
                    .map((item) => {
                      return <PigAndWifeAlbumCover key={item.id} info={item} />;
                    })}{" "}
                </div>
              );
            })}{" "}
