...
import PigAndWifeThemeHeaderSmall from "@/components/theme-header-small";
import { SetterSongerWrapper } from "./style";

export default memo(function PigAndWifeSettleSinger() {
  // redux
  ...
  return (
    <SetterSongerWrapper>
      <PigAndWifeThemeHeaderSmall title="入驻歌手" more="查看全部>" />
