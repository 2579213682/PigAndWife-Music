...
import PigAndWifeThemeHeaderPlayer from "@/components/theme-header-player";
import { PlayerSongsWrapper } from "./style";
import { getSimiPlaylistAction } from "../../store/actionCreators";

export default memo(function PigAndWifePlayerSongs() {
  // redux hooks
  ...
  return (
    <PlayerSongsWrapper>
      <PigAndWifeThemeHeaderPlayer title="包含这首歌的歌单" />
      <div className="songs">
        {" "}
