...
import PigAndWifeAppPlayPanel from "../app-play-panel";
import { NavLink } from "react-router-dom";
import { Slider } from "antd";
import { PlaybarWrapper, Control, PlayInfo, Operator } from "./style";

export default memo(function PigAndWifeAppPlaybar() {
  // props and state
    ...
    <PlaybarWrapper className="sprite_playbar">
      <div className="content wrap-v2">
        <Control isPlaying={isPlaying}>
          ...
          <button className="sprite_playbar btn play" onClick={(e) => play()}>
            {" "}
          </button>{" "}
          <button
      ...
      {showPanel && <PigAndWifeAppPlayPanel />}{" "}
    </PlaybarWrapper>
  );
});
